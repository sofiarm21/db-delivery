...
GRANT ALL ON DATOS_EMPRESA TO GERENTE_PROV;
GRANT ALL ON RANGO_FECHA TO GERENTE_PROV;
GRANT ALL ON UBICACION TO GERENTE_PROV;
...
GRANT SELECT, UPDATE, INSERT ON DATOS_EMPRESA TO CONDUCTOR_PROV;
GRANT SELECT, UPDATE, INSERT ON RANGO_FECHA TO CONDUCTOR_PROV;
GRANT SELECT, UPDATE, INSERT ON UBICACION TO CONDUCTOR_PROV;
...
GRANT ALL ON DATOS_EMPRESA TO GERENTE_EA;
GRANT ALL ON RANGO_FECHA TO GERENTE_EA;
GRANT ALL ON UBICACION TO GERENTE_EA;
...
GRANT SELECT, UPDATE ON DATOS_EMPRESA TO EMPLEADO_EA;
GRANT SELECT, UPDATE ON RANGO_FECHA TO EMPLEADO_EA;
GRANT SELECT, UPDATE ON UBICACION TO EMPLEADO_EA;
...
GRANT ALL ON DATOS_EMPRESA TO CLIENTE;
GRANT ALL ON RANGO_FECHA TO CLIENTE;
GRANT ALL ON UBICACION TO CLIENTE;
